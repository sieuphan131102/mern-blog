...
const PostCard = ({ post }) => {
  return (
    <div
      className="group relative w-full border border-teal-500 hover:border-2 h-[400px] overflow-hidden rounded-lg
    sm:w-[430px]"
    >
      ...
      <div className="p-3 flex flex-col gap-2">
        ...
        <Link
          ...
          border border-teal-500 hover:bg-teal-500 hover:text-white transition-all
